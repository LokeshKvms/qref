            ...
            <form method="POST" action="{{ route('links.store') }}" class="space-y-6">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input placeholder="Title" type="text" name="title" value="{{ old('title') }}"
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input placeholder="Link" type="url" name="url" value="{{ old('url') }}"
                            class="w-full pl-10 pr-3 py-2 border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded text-sm focus:outline-none focus:ring focus:border-blue-400"
                            required>
                    </div>
                    @error('url')
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input placeholder="Icon Link" type="url" name="image_url" value="{{ old('image_url') }}"
                            class="w-full pl-10 pr-3 py-2 border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded text-sm focus:outline-none focus:ring focus:border-blue-400">
                    </div>
